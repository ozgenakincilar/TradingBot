...
- [ ] v5 DMI domain/strategy implementasyonu, legacy hash regression testleri ve fail-closed v4-v5 validation CLI.
- [ ] Ayrı 2021 historical development train/validation değerlendirmesi; holdout açılmayacak ve sonuç forward OOS sayılmayacak.
