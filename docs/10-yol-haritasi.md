...
- [x] Forward evidence için gerçek SQL append-only trigger/rollback testi, yedi bölümlü streaming E2E prova, persistence'sız OKX smoke, tek-yazar lease ve temel health/metric uçları.
