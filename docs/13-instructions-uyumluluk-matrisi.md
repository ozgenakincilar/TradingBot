...
| 80 | Regime switching | 🟡 Kısmi | Exact Wilder `ADX(14) >= 25` v4 filtresi 2022 historical validation'da trade ve maliyeti `%42+` azalttı fakat profit factor/net/benchmark/kârlı pencere kapılarını geçemediği için reddedildi. Yeni ön kayıtlı rejim hipotezi ve gerçek forward OOS kanıtı kaldı. [v4 ret kanıtı](20-2022-v4-validation-kaniti.md), [ADX](../src/TradingBot.Domain/Strategies/AverageDirectionalIndex.cs), [ADR-0023](adr/0023-adx-trend-kalite-v4-arastirma-adayi.md) |
...
| 89 | Overfitting | 🟡 Kısmi | Ön kayıtlı v4 yalnız 2022 historical train/validation'da çalıştırıldı, başarısızlık sonrası eşikler değiştirilmedi ve holdout açılmadı. Sonuç forward OOS sayılmıyor; yeni aday için yeni ön kayıt/veri sınırı ve gerçek forward OOS gereklidir. [v4 ret kanıtı](20-2022-v4-validation-kaniti.md), [validation](../src/TradingBot.Application/Backtesting/AdxRegimeValidation.cs), [ADR-0023](adr/0023-adx-trend-kalite-v4-arastirma-adayi.md) |
