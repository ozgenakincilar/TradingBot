...
| 89 | Overfitting | 🟡 Kısmi | Chronological/OOS kilidi, rolling/expanding schedule ve gerçek 2025 v1 ret kanıtı mevcut. v2 ayrı 2024 validation'da reddedildi; eşikler gevşetilmedi ve yeni OOS açılmadı. İşlem kaybı attribution'ı ayrı diagnostics artifact'ıdır ve doğrudan parametre optimizasyonu yapmaz. Yeni hipotez için ayrı development ve çoklu-rejim OOS kanıtı kaldı. [2025 OOS kanıtı](14-2025-oos-baseline-kaniti.md), [2024 v2 validation kanıtı](15-2024-v2-validation-kaniti.md), [v2 kayıp attribution](16-2024-v2-kayip-attribution-kaniti.md), [ADR-0021](adr/0021-deterministik-islem-kayip-attribution.md) |
