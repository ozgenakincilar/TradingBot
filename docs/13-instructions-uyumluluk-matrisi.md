...
| 80 | Regime switching | 🟡 Kısmi | Deterministik `1H close > EMA200` yön filtresi ve yalnız entry'de checked decimal exact Wilder `ADX(14) >= 25` isteyen v4 trend-kalite filtresi testli olarak uygulandı. 2022 historical validation ve gerçek forward OOS kanıtı kaldı. [v4 ön kayıt/uygulama](19-v4-adx-rejim-on-kaydi.md), [ADX](../src/TradingBot.Domain/Strategies/AverageDirectionalIndex.cs), [ADR-0023](adr/0023-adx-trend-kalite-v4-arastirma-adayi.md) |
...
| 89 | Overfitting | 🟡 Kısmi | Chronological/OOS kilidi ve gerçek ret kanıtları mevcut. Ön kayıtlı v4 ile sekiz fail-closed acceptance kapısını uygulayan `validate-adx-regime-v4` hazırdır; ilk 2022 çalışma yalnız historical development validation sayılacak, holdout açılmayacak ve gerçek forward OOS için 2026-07-27 sonrası veri beklenecek. [v4 ön kayıt/uygulama](19-v4-adx-rejim-on-kaydi.md), [validation](../src/TradingBot.Application/Backtesting/AdxRegimeValidation.cs), [ADR-0023](adr/0023-adx-trend-kalite-v4-arastirma-adayi.md) |
